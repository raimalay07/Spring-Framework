...
public class MyDemoLoggingAspect {
	...
	public Object aroundGetFortune(
		...
		Object result = theProceedingJoinPoint.proceed(); // theProceedingJoinPoint -> handle to target method
														  // proceed() -> Execute the target method
		
		// get end timestamp
		long end = System.currentTimeMillis();
		
		// compute duration and dispaly it
	...
	// add a new advice for @After (Finally)
